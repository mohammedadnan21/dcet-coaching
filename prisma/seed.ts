...
async function main() {
  ...
  // Create admin user (Mohammed Adnan)
  const adminPassword = await bcrypt.hash("Admin@48Rank", 12);
  
  const admin = await prisma.user.upsert({
    where: { email: "muhammedadnan50007@gmail.com" },
    update: {},
    create: {
      name: "Mohammed Adnan",
      email: "muhammedadnan50007@gmail.com",
      phone: "9844942547",
