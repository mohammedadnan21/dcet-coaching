...
import { Plus, Calendar, Clock, Video, XCircle, ExternalLink, Trash2 } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Schedule and manage Zoom meetings</p>
        </div>
        ...
        <div className="space-y-4">
          {meetings.map((meeting) => {
            ...
            return (
              <Card
                key={meeting.id}
                className={`border-0 shadow-md ${meeting.cancelled ? "opacity-60" : ""}`}
              >
