...
export default function QuestionsPage() {
  ...
  const getVisibilityBadge = (visibility: string) => {
    if (visibility === "PUBLIC") {
      return <Badge className="bg-green-100 text-green-700"><Globe className="w-3 h-3 mr-1" />Public</Badge>;
    }
    return <Badge className="bg-amber-100 text-amber-700"><Lock className="w-3 h-3 mr-1" />Private</Badge>;
  };
